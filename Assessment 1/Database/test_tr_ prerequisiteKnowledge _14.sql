/* 
This script creates the tables and trigger and runs some statements at the
bottom to demonstrate trigger.

There is also some commented out lines at the bottom for extra testing.
*/
...
-- Testing inserting into StudentRegisterInCourse table (there is also update commented out below)
